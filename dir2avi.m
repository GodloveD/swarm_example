...
% passed, it will just look in the current working dirctory and save an avi
% there.
%
% Written by godlovedc@helix.nih.gov 2015-11-13
%
% OPTIONAL INPUT:
%     framepath    = where to look for the images to convet to video frames
...
%                    file already exists to avoid ovewriting)
