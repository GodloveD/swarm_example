...
memory              = '1';                       % in gb per cpu 
partition           = 'norm';                    % see freen for other ideas
processors_per_task = '1';                       % set to 2 to "pack" 2 jobs on 2 (hyperthreaded) cpus
bundleN             = '1';                       % set bundleN > 1 to run several jobs sequentially on 1 cpu
time                = '00:10:00';                % "hours:minutes:seconds or days-hours:minutes:seconds"
...
dependancy_name     = 'dir2avi.job';             % Give the dependancy job file a name.

% set up all the variables for the code to run
kclusters  = 7;                    % supply the "k" in "kmeans" (i.e. number of clusters)
reps       = 15;                   % how many repititions to ensure that kmeans algorithm converges properly
...
fmt        = 'png';                % In what format do you want to save the analyzed images?
...
shell_script_dir  = fullfile(parent_dir,'compiled');     % where the compiled mat code is located and where the swarm file will be saved
...
% STEP 1) recompile the code (if the user wants it)
% ------------------------------------------------------------------------------
if recompile_code
    ...
    % subdirectory keeping everthing nice and neat
...
% STEP 2) generate the swarm script and save it 
% ------------------------------------------------------------------------------
...
% STEP 3) create and run any subsequent dependant jobs
% ------------------------------------------------------------------------------
